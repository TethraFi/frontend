...
const OneTapProfitModal: React.FC<OneTapProfitModalProps> = ({
  ...
  const { hasAllowance, approve, isPending: isApproving, checkAllowance } = useOneTapProfitApproval();
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              disabled={isPlacingBet || isCalculating || !multiplier || isApproving}
            ...
            >
              {isApproving ? 'Approving USDC...' : isPlacingBet ? 'Placing Bet...' : 'Place Bet'}
            </button>
          </div>
